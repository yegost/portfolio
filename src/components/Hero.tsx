    ...
    return(
        <header className="dark:bg-neutral-800">
            <div className="mx-auto max-w-3xl px-6 pb-67 pt-63">
                ...
                <div className="flex flex-wrap  font-manrope gap-3">
                    <a
                        href="#projects"
                        className="flex text-sm font-semibold tracking-wide justify-center rounded relative w-40 overflow-hidden bg-neutral-900 text-white transition-all before:absolute before:bottom-0 before:right-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white  before:transition-all before:duration-500 border border-neutral-300 hover:text-black hover:before:right-0 hover:before:w-full"
                    >
                        <span className="relative flex justify-center items-center gap-1 z-10">View Projects
